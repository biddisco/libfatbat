...
public:
	...
	int handle_send_completion_impl()
	{
		return 0;
	}
	...
	int handle_recv_completion_impl(std::uint64_t /*len*/)
	{
		return 0;
	}
	...
	int handle_tagged_recv_completion_impl(bool /*threadlocal*/)
	{
		return 0;
	}
