...
int main(int argc, char** argv)
{
...

  {
    ...
    for (int i = 0; i < size; i++)
    {
      ...
      // to make validation easy, we will allocate this on the CPU
      ...
      LIBFATBAT_INFO(
          rdmatest_log, "{:<20} rank {} : local GPU buffer {}", "Allocating", rank, message_size);
      auto local_data_buffer = heap.allocate(message_size, 0, GPU_device);
